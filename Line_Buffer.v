...
module Line_Buffer #(parameter PIXW = 8, LB_size = 20)
   (input clk_50M,
...
wire [4:0] pos1 = (base_pos + 1 >= LB_size) ? (base_pos + 1 - LB_size) : (base_pos + 1);
wire [4:0] pos2 = (base_pos + 2 >= LB_size) ? (base_pos + 2 - LB_size) : (base_pos + 2);
